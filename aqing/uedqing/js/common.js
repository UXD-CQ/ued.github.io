...
$(document).ready(function() {
    ...
    // TODO: 临时去掉一下 easeScroll 比较卡, by XD
    // $('body').easeScroll({
    //     frameRate: 60,
    //     animationTime: 1500,
    //     stepSize: 120,
    ...
    $('.masonry .item-masonry').css('visibility', 'hidden');
    +(function progressMasonryGrid(n) {
        if (n > $('.masonry .item-masonry').length) {
            return
        }
        $('.masonry .item-masonry').slice(0, n).css('visibility', 'visible').addClass('js-masonry-show')
        var $masonryGrid=$('.masonry').isotope({
            itemSelector: '.item-masonry.js-masonry-show',
